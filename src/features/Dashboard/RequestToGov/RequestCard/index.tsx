            ...
            <div className="w-full flex justify-between items-center ">
              <div className="flex flex-col gap-2 items-start">
                <div className="flex gap-1 items-center">
                  ...
                  <span className="text-blue-primary text-xs">Nasib Babazadə</span>
                </div>
                <span className="text-surface-secondary text-sm font-medium">ID:12345</span>
              </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                <div className="flex px-5 py-2 gap-2 bg-gray-disabled rounded-[100px]">
                  ...
                  <span className="text-text-gray text-xxs">Gözləmədə</span>
                </div>
              ...
              <p className="text-parag-gray text-sm font-medium">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores possimus quasi
                totam odio cumque? Magni ut repellendus dignissimos excepturi laborum.
              </p>
            </div>
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                <Image src={LocationIcon} alt="location" width={20} height={20} />
                <span className="text-sm-alt text-blue-primary">Suraxanı rayonu</span>
              </div>
              <div className="flex gap-2">
                <Image src={CalendarIcon} alt="calendar" width={20} height={20} />
                <span className="text-sm-alt ">12.02.2024</span>
              </div>
            </div>
            <Divider />
            <div className="flex justify-between items-center">
