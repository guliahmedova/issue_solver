        ...
        {openPopup && (
          <div className="fixed top-0 bottom-0 lg:right-0 lg:left-auto right-0 left-0 w-full bg-black/30 lg:w-6/12 h-full z-40 flex flex-col justify-center items-center">
            <Box className="bg-white rounded-md shadow border p-6">
              <Box className="">
                <Typography className="text-xl select-none mb-5">
        ...
        <Box component="div" className={`${style.confirm_otp_content} lg:w-[68%] w-11/12 mx-auto`}>
              ...
              <Box component="div" height={20} className="mt-4">
                {timer != 0 && (
                  <Typography
                    fontSize="17px"
                    color="#2981FF"
                    className="select-none flex items-center gap-1.5 text-lg"
                  >
                    <Image src={time} alt="" /> {`${Math.floor(timer / 60)}`.padStart(2, "0")}:
              ...
              index === 3 ? (
                ...
                <Grid item key={index} textAlign="center">
                  <OutlinedInput
                    ...
                    sx={
                      success ? null : { border: "2px solid #EF5648", backgroundColor: "#FF3D2C0F" }
                    }
                    inputProps={{
          ...
          <Box component="div" marginTop="83px">
            <Button
              ...
              disabled={btnsDisabled.primaryBtn ? true : false}
              fullWidth
              sx={{
          ...
          <Box component="div" textAlign="center" paddingBlock="16px">
            <Button
              variant="secondary"
              fullWidth
              disabled={btnsDisabled.secondaryBtn ? true : false}
              onClick={handleSendOtpAgainBtn}
              sx={{
                textTransform: "capitalize",
              }}
            >
