...
const Privacy = () => {
    return (
        <div className="p-8">
            ...
            <div className="mt-3">
                <h3 className="font-medium text-xl">Təşəbbüslərə Müraciət Et vətəndaşların dövlət xidmətlərinə sorğularını göndərən tətbiq üçün Təhlükəsizlik Qaydaları:</h3>

                <ol>
                    <li className="mt-2">1. Şəxsi Məlumatların Mühafizəsi:
                    ...
                    <li className="mt-2">
                        3. Yalançı Və Sayta Xəbərdarlıq:
